...
*Budgie support has now been dropped due to the founder and lead developer kindly pointing out that the theme doesn’t support the budgie desktop sorry for any inconvenience to any users, you can see the full issue [here](https://github.com/LinxGem33/OSX-Arc-White/issues/28)
##
