...
> [osx-arc-collection_1.4.1_amd64.deb](https://github.com/LinxGem33/OSX-Arc-White/releases)

> [osx-arc-collection_1.4.1_i386.deb](https://github.com/LinxGem33/OSX-Arc-White/releases)
...
<sub>Screenshot Details: Icons: [OSX-Arc Icons](https://github.com/LinxGem33/Arc-OSX-Icons) | System Icons based on [Paper Project Icons](https://github.com/snwh/paper-icon-theme) | [Wallpaper](https://github.com/LinxGem33/OSX-Arc-White/blob/master/extra/mountains.png?raw=true) | Font: Liberation Sans</sub>
